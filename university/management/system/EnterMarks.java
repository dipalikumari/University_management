...
public class EnterMarks extends JFrame implements ActionListener {
    ...
    EnterMarks(){
        ...
        tfsub1.setBounds(49, 200, 200, 20);
        add(tfsub1);
        
        tfsub2=new JTextField();
        tfsub2.setBounds(49, 230, 200, 20);
        add(tfsub2);
        
        tfsub3=new JTextField();
        tfsub3.setBounds(49, 260, 200, 20);
        add(tfsub3);
        
        tfsub4=new JTextField();
        tfsub4.setBounds(49, 290, 200, 20);
        add(tfsub4);
        
        tfsub5=new JTextField();
        tfsub5.setBounds(49, 320, 200, 20);
        add(tfsub5);
        
        // marks 
        tfmarks1=new JTextField();
        tfmarks1.setBounds(249, 200, 200, 20);
        add(tfmarks1);
        
        tfmarks2=new JTextField();
        tfmarks2.setBounds(249, 230, 200, 20);
        add(tfmarks2);
        
        tfmarks3=new JTextField();
        tfmarks3.setBounds(249, 260, 200, 20);
        add(tfmarks3);
        
        tfmarks4=new JTextField();
        tfmarks4.setBounds(249, 290, 200, 20);
        add(tfmarks4);
        
        tfmarks5=new JTextField();
        tfmarks5.setBounds(249, 320, 200, 20);
        add(tfmarks5);
